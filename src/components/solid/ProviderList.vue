...
data() {
  return {
    ...
    options: [
      ...
      {text: "https://solidcommunity.net", description:"solidcommunity.net is a public Solid server.", url:"https://solidcommunity.net/"},
      {text: "https://solidweb.org", description:"solidweb.org is a public Solid server based in Germany which is in an experimental state.", url:"https://solidweb.org/"},
      {text: "https://inrupt.net", description:"inrupt.net is a public Solid server provided by Inrupt, Inc.", url:"https://inrupt.net/"},
