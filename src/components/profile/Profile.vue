    ...
    <div  v-if="webId != null" class="accordion" role="tablist">
      ...
      <b-card no-body class="mb-1">
        ...
        <b-collapse id="accordion-5" accordion="my-accordion" role="tabpanel">
          <b-card-body>
            <b-card-text>
     <b-button to="/workspaces" variant="info"> <b-icon-pen></b-icon-pen> Workspaces</b-button>
</b-card-text>
          </b-card-body>
        </b-collapse>
      </b-card>
      ...
      <b-card no-body class="mb-1">
        ...
        <b-collapse id="accordion-6" accordion="my-accordion" role="tabpanel">
          <b-card-body>
                <b-card-text>
          <b-button to="/friends" variant="info"> <b-icon-eye></b-icon-eye> Friends</b-button>
          <b-button to="/fofri" variant="info"> <b-icon-eye></b-icon-eye> Following Friends</b-button>
